...
class RoundFactorySpec  extends WordSpec with Matchers {
  "An RoundFactorySpec" should {
    ...
    "default routes 0" in {
      val roundFactory = new RoundFactory
      var temp = roundFactory.getInstance(0, None).siteID should be(0)
