...
import de.htwg.se.durak.controller.gameLogicComponent.gameLogicBaseImpl.RoundDataFactory
...
class RoundDataFactorySpec  extends WordSpec with Matchers {
  /*"An RoundFactorySpec" should {
    ...
    "default routes 0" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(0, None)
    ...
    "default routes 2" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(2, None)
      temp.siteID should be(2)
      temp.param should be(None)
    }
    "default routes 3" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(3, None)
      temp.siteID should be(3)
      temp.param should be(None)
    }
    "default routes 10" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(10, None)
      temp.siteID should be(10)
      temp.param should be(None)
    }
    "default routes 11" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(11, None)
      temp.siteID should be(11)
      temp.param should be(None)
    }
    "default routes 12" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(12, None)
      temp.siteID should be(12)
      temp.param should be(None)
    }
    "default routes 13" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(13, None)
      temp.siteID should be(13)
      temp.param should be(None)
    }
    "default routes 404" in {
      val roundFactory = RoundFactory()
      val temp = roundFactory.getInstance(404, None)
      temp.siteID should be(0)
      temp.param should be(None)
    }
